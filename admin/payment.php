    ...
    <div class="wrapper">
      <div class="form-style-3">
              ...
              <label for="room_label"><span>Room label</span>
                ...
                <label for="pay_date"><span>Payment date</span>
                  ...
                  <label for="room_monthly_price"><span>Room Price</span>
                    ...
                    <label for="pay_date"><span>Brokes/Lost Items</span></label>
                    <table>
                      <tr>
                        <td><input type="checkbox" class="input-field" value="1500000" name="item[]"/></td>
                        <td>Broken bed</td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" class="input-field" value="30000" name="item[]"/></td>
                        <td>Light bulb</td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" class="input-field" value="150000" name="item[]"/></td>
                        <td>Desk/chair/cabinet</td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" class="input-field" value="1500000" name="item[]"/></td>
        ...
        if(isset($_POST['submit'])) {
            ...
            $payment_total = ($_POST['room_monthly_price']+array_sum($items));
